...
const Footer = () => {
  return (
    <footer className='body bg-white  w-full py-8 mt-8'>
      <div className='max-w-screen-xl mx-auto px-4'>
        <div className=' flex max-w-xs mx-auto items-center justify-between'>
          ...
          <a target="_blank"
            href='https://twitter.com/Shafin143Shafin'
            className='text-gray-400 hover:text-gray-800 transition-colors duration-200'
          >
            <svg
              width='20'
          ...
          <a target="_blank"
            href='https://www.linkedin.com/in/tanvir-rahman-88a09b229/'
            className='text-gray-400 hover:text-gray-800 transition-colors duration-200'
          >
            <svg
              width='20'
        ...
        <div className='text-center text-cyan-600 pt-10 sm:pt-12 font-light flex items-center justify-center'>
          All Rights Reserved By &copy; SHAFIN CRYPTOOL STORE | 2022-2026
        </div>
      </div>
    </footer>
  )
