                ...
                <div className='px-4 pt-20 pb-24 mx-auto max-w-7xl md:px-2'>
                    <div className='h-full grid grid-cols-1 md:grid-cols-2 justify-items-center gap-4 md:justify-items-around content-center'>
                        <div className='order-2 md:order-1'>
                            ...
                            <h1>Contract Address: {coin.contract_address}
                                {coin.contract_address ? coin.contract_address : 'No Data Found'}
                            </h1>
                            <h1>Hashing Algorithm: {coin.hashing_algorithm}
                                {coin.hashing_algorithm ? coin.hashing_algorithm : 'Not Available'}
                            </h1>
                            <h1>Genesis Date: {coin.genesis_date}
                                {coin.genesis_date ? coin.genesis_date : 'No Data'}
                            </h1>
                            <h1>Last Updated: {coin.last_updated}
                                {coin.last_updated ? coin.last_updated : 'Not Found'}
                            </h1>
